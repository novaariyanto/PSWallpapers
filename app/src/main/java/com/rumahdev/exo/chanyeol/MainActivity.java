...
import com.rumahdev.exo.chanyeol.databinding.ActivityMainBinding;
...
//        ConsentInformation a = ConsentInformation.getInstance(getBaseContext());
    ...
    private void initUIAndActions() {
        ...
        if(!Config.ENABLE_PREMIUM){
            ...
            navViewMenu.findItem(R.id.nav_category).setVisible(false);
            navViewMenu.findItem(R.id.nav_category_login).setVisible(false);
            bottomNavigationViewMenu.findItem(R.id.premium_menu).setVisible(false);
            bottomNavigationViewMenu.findItem(R.id.category_menu).setVisible(false);
        }
