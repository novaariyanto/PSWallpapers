package com.rumahdev.exo.chanyeol.ui.dashboard.adapter.portrait;
...
import com.rumahdev.exo.chanyeol.databinding.ItemPortraitAdapterBinding;
...
public class PortraitAdapter extends DataBoundListAdapter<Wallpaper, ItemPortraitAdapterBinding> {

    private final androidx.databinding.DataBindingComponent dataBindingComponent;
    public PortraitAdapter.AllWallpapersClickCallback callback;
    private DataBoundListAdapter.DiffUtilDispatchedInterface diffUtilDispatchedInterface = null;

    public PortraitAdapter(androidx.databinding.DataBindingComponent dataBindingComponent,
                           PortraitAdapter.AllWallpapersClickCallback callback) {
    ...
    @Override
    protected ItemPortraitAdapterBinding createBinding(ViewGroup parent) {
        ItemPortraitAdapterBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()),
                R.layout.item_portrait_adapter, parent, false,
    ...
    @Override
    protected void bind(ItemPortraitAdapterBinding binding, Wallpaper wallpaper) {
        if (wallpaper != null) {
