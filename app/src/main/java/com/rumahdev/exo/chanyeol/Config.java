...
public class Config {
     ...
     */
    public static final String APP_API_URL = "https://universal1.masalah.my.id/index.php/";
    public static final String APP_IMAGES_URL = "";
    public static final String APP_IMAGES_THUMB_URL = "";
    ...
    public static final String CATEGORY_ID = "cate4b9c0fd7b5efc2b9f3131eb63378109";
    ...
    public static String POLICY_URL = "https://masalah.my.id/privacy-policy/chanyeol.html";
     ...
     * Show or Hide Gif
     */
    public static boolean ENABLE_GIF = false;

    /**
     * Show or Hide Live Wallpaper
     */
    public static boolean ENABLE_LIVE_WALLPAPER = false;
     ...
     */
    public static boolean ENABLE_PREMIUM = false;
