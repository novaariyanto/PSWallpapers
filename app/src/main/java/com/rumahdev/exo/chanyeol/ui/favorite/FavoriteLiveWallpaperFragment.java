package com.rumahdev.exo.chanyeol.ui.favorite;
...
import com.rumahdev.exo.chanyeol.databinding.FragmentFavoriteListBinding;
 ...
 */
public class FavoriteLiveWallpaperFragment extends PSFragment {
    //region Variables
    ...
    protected void initUIAndActions() {
                        ...
                        if ((visibleItemCount + pastVisibleItems) >= totalItemCount) {
                            ...
                            if (!binding.get().getLoadingMore() && !wallpaperViewModel.forceEndLoading) {
                                ...
                                if (connectivity.isConnected()) {
                                    ...
                                    wallpaperViewModel.setNextPageFavLoadingStateObj(loginUserId, String.valueOf(Config.FAVORITE_COUNT), String.valueOf(wallpaperViewModel.offset),Constants.LIVE_WALLPAPER);
                                }
        ...
        binding.get().swipeRefresh.setOnRefreshListener(() -> {
            ...
            // update live data
            wallpaperViewModel.setAllFavoriteWallpaperObj(loginUserId, String.valueOf(Config.FAVORITE_COUNT), String.valueOf(wallpaperViewModel.offset),Constants.LIVE_WALLPAPER);
...
//
//    @androidx.annotation.VisibleForTesting
//    private AutoClearedValue<FragmentFavoriteLiveWallpaperBinding> binding;
...
//
//        // Inflate the layout for this fragment
//        FragmentFavoriteLiveWallpaperBinding dataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_favorite_live_wallpaper, container, false, dataBindingComponent);
//
//        setHasOptionsMenu(true);
//        binding = new AutoClearedValue<>(this, dataBinding);
//
...
//
//                                    liveWallpaperViewModel.setNextPageFavLoadingStateObj(loginUserId, String.valueOf(Config.FAVORITE_COUNT), String.valueOf(liveWallpaperViewModel.offset));
//                                }
//
//                            }
//                        }
...
//
//            // update live data
//            liveWallpaperViewModel.setAllFavoriteLiveWallpaperObj(loginUserId, String.valueOf(Config.FAVORITE_COUNT), String.valueOf(liveWallpaperViewModel.offset));
//
//        });
//    }
//
...
//                navigationController.navigateToFavLiveWallpaperDetail(getActivity(), wallpaper, favouriteLiveWallpaperViewModel.favQueryListWallpaperParamsHolder);
//            }
//
//            @Override
...
//
//        liveWallpaperViewModel.setAllFavoriteLiveWallpaperObj(loginUserId, String.valueOf(Config.FAVORITE_COUNT), String.valueOf(liveWallpaperViewModel.offset));
//        liveWallpaperViewModel.getAllFavoriteLiveWallpaperData().observe(this, resource -> {
//
//            if (resource != null) {
//
//                Utils.psLog("Got Data" + resource.message + resource.toString());
...
//                        liveWallpaperViewModel.setLoadingState(false);
//
//                        if (liveWallpaperViewModel.getAllFavoriteLiveWallpaperData() != null) {
//                            if (liveWallpaperViewModel.getAllFavoriteLiveWallpaperData().getValue() != null) {
//                                if (liveWallpaperViewModel.getAllFavoriteLiveWallpaperData().getValue().data != null) {
//                                    if (!binding.get().getLoadingMore() && liveWallpaperViewModel.getAllFavoriteLiveWallpaperData().getValue().data.size() == 0) {
//                                        binding.get().noItemConstraintLayout.setVisibility(View.VISIBLE);
//                                    }
//                                }
//                            }
...
//        });
//
//        liveWallpaperViewModel.getNextPageFavLoadingStateData().observe(this, state -> {
//            if (state != null) {
//                if (state.status == Status.ERROR) {
//                    Utils.psLog("Next Page State : " + state.data);
//
